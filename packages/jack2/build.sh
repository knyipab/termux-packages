...
TERMUX_PKG_DEPENDS="alsa-lib, libdb, dbus, libandroid-shmem, libandroid-posix-semaphore, libandroid-sysv-semaphore, libexpat, libsamplerate, libopus"
TERMUX_PKG_CONFLICTS="jack1, pipewire-jack"
TERMUX_PKG_PROVIDES="jack1, pipewire-jack"
TERMUX_PKG_BUILD_IN_SRC=true

termux_step_configure() {
	LDFLAGS+=" -landroid-shmem -landroid-posix-semaphore -landroid-sysv-semaphore"
