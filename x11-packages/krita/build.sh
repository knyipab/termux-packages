...
# TERMUX_PKG_SHA256=f043eed9245412dffc43fe6cd3d2e417b224b045dc574cb6291448d4c55dcea8
TERMUX_PKG_VERSION=0.20240925
TERMUX_PKG_SRCURL=git+https://github.com/KDE/krita
TERMUX_PKG_GIT_BRANCH=master
TERMUX_PKG_DEPENDS="exiv2, ffmpeg, fftw, fontconfig, freetype, fribidi, giflib, gsl, harfbuzz, imath, kf6-kcompletion, kf6-kconfig, kf6-kcoreaddons, kf6-kguiaddons, kf6-ki18n, kf6-kitemmodels, kf6-kitemviews, kf6-kwidgetsaddons, kf6-kwindowsystem, littlecms, libjpeg-turbo, libpng, libtiff, libunibreak, libwebp, libx11, mlt, opencolorio, openexr, openjpeg, qt6-qt5compat, qt6-qtbase, qt6-qtsvg, quazip-qt6, zlib"
...
# TODO: kimageformats, krita-plugin-gmic, pyqt6
