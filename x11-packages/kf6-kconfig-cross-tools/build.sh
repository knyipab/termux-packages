...
TERMUX_PKG_DEPENDS="kf6-kconfig"
...
termux_step_host_build() {
	...
	EOF
	sed -e 's|#include "../core/kconfig_version.h"|#include "'$TERMUX_PREFIX'/include/KF6/KConfig/kconfig_version.h"|' -i $TERMUX_PKG_SRCDIR/src/kconfig_compiler/kconfig_compiler.cpp
